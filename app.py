...
def process_file(pdf):
    ...
    pdfsearch = Chroma.from_documents(pdf, embeddings)
    chain = ConversationalRetrievalChain.from_llm(ChatGroq(model="openai/gpt-oss-120b",temperature=1, reasoning_effort="medium"),
